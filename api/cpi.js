...
module.exports = async (req, res) => {
  const TIKTOK_PIXEL_ID_CPI = process.env.TIKTOK_PIXEL_ID_CPI || 'D4E4MGRC77UD5T3PRVHG';
  const TIKTOK_ACCESS_TOKEN_CPI = process.env.TIKTOK_ACCESS_TOKEN_CPI;
  ...
  try {
    ...
    const payload = {
      pixel_code: TIKTOK_PIXEL_ID_CPI,
      ...
      properties: {
        ...
        content_id: 'playful-rewards-offers',
        value: 1.00,
        currency: 'USD'
      }
    };
    ...
    const response = await axios.post(
      ...
      {
        headers: {
          'Access-Token': TIKTOK_ACCESS_TOKEN_CPI,
